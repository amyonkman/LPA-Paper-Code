...
date: "19/10/2020, edited in March 2022"
...
percent_home_1 <- 100*(nrow(filter(clust_opps, home_1 == 1)))/nrow(clust_opps)
percent_home_2 <- 100*(nrow(filter(clust_opps, home_2 == 1)))/nrow(clust_opps)
percent_home_3 <- 100*(nrow(filter(clust_opps, home_3 == 1)))/nrow(clust_opps)
percent_home_4 <- 100*(nrow(filter(clust_opps, home_4 == 1)))/nrow(clust_opps)

percent_city_van <- 100*(nrow(filter(clust_opps, city_van == 1)))/nrow(clust_opps)
percent_city_tor <- 100*(nrow(filter(clust_opps, city_tor == 1)))/nrow(clust_opps)
percent_city_ham <- 100*(nrow(filter(clust_opps, city_ham == 1)))/nrow(clust_opps)
percent_city_king <- 100*(nrow(filter(clust_opps, city_king == 1)))/nrow(clust_opps)
percent_city_mon <- 100*(nrow(filter(clust_opps, city_mon == 1)))/nrow(clust_opps)
percent_city_hal <- 100*(nrow(filter(clust_opps, city_hal == 1)))/nrow(clust_opps)

opps_cluster_demog <- c(percent_male1, percent_female1, percent_age_nineteen1, percent_age_thirty1, percent_age_thirtyfive1, percent_white1, percent_nonwhite1, percent_hs1, percent_college1, percent_undergrad1, percent_grad1, percent_married1, percent_unmarried1, percent_under_forty1, percent_forty1, percent_eighty1, percent_hundred1, percent_parity_zero1, percent_parity_one1, percent_parity_two1, percent_parity_three_plus1, percent_nonsmoker1, percent_smoker1, percent_nonalc1, percent_alc1, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
percent_home_1 <- 100*(nrow(filter(clust_ref, home_1 == 1)))/nrow(clust_ref)
percent_home_2 <- 100*(nrow(filter(clust_ref, home_2 == 1)))/nrow(clust_ref)
percent_home_3 <- 100*(nrow(filter(clust_ref, home_3 == 1)))/nrow(clust_ref)
percent_home_4 <- 100*(nrow(filter(clust_ref, home_4 == 1)))/nrow(clust_ref)

percent_city_van <- 100*(nrow(filter(clust_ref, city_van == 1)))/nrow(clust_ref)
percent_city_tor <- 100*(nrow(filter(clust_ref, city_tor == 1)))/nrow(clust_ref)
percent_city_ham <- 100*(nrow(filter(clust_ref, city_ham == 1)))/nrow(clust_ref)
percent_city_king <- 100*(nrow(filter(clust_ref, city_king == 1)))/nrow(clust_ref)
percent_city_mon <- 100*(nrow(filter(clust_ref, city_mon == 1)))/nrow(clust_ref)
percent_city_hal <- 100*(nrow(filter(clust_ref, city_hal == 1)))/nrow(clust_ref)

ref_cluster_demog <- c(percent_male2, percent_female2, percent_age_nineteen2, percent_age_thirty2, percent_age_thirtyfive2, percent_white2, percent_nonwhite2, percent_hs2, percent_college2, percent_undergrad2, percent_grad2, percent_married2, percent_unmarried2, percent_under_forty2, percent_forty2, percent_eighty2, percent_hundred2, percent_parity_zero2, percent_parity_one2, percent_parity_two2, percent_parity_three_plus2, percent_nonsmoker2, percent_smoker2, percent_nonalc2, percent_alc2, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
percent_home_1 <- 100*(nrow(filter(clust_phthalate, home_1 == 1)))/nrow(clust_phthalate)
percent_home_2 <- 100*(nrow(filter(clust_phthalate, home_2 == 1)))/nrow(clust_phthalate)
percent_home_3 <- 100*(nrow(filter(clust_phthalate, home_3 == 1)))/nrow(clust_phthalate)
percent_home_4 <- 100*(nrow(filter(clust_phthalate, home_4 == 1)))/nrow(clust_phthalate)

percent_city_van <- 100*(nrow(filter(clust_phthalate, city_van == 1)))/nrow(clust_phthalate)
percent_city_tor <- 100*(nrow(filter(clust_phthalate, city_tor == 1)))/nrow(clust_phthalate)
percent_city_ham <- 100*(nrow(filter(clust_phthalate, city_ham == 1)))/nrow(clust_phthalate)
percent_city_king <- 100*(nrow(filter(clust_phthalate, city_king == 1)))/nrow(clust_phthalate)
percent_city_mon <- 100*(nrow(filter(clust_phthalate, city_mon == 1)))/nrow(clust_phthalate)
percent_city_hal <- 100*(nrow(filter(clust_phthalate, city_hal == 1)))/nrow(clust_phthalate)

phthalate_cluster_demog <- c(percent_male3, percent_female3, percent_age_nineteen3, percent_age_thirty3, percent_age_thirtyfive3, percent_white3, percent_nonwhite3, percent_hs3, percent_college3, percent_undergrad3, percent_grad3, percent_married3, percent_unmarried3, percent_under_forty3, percent_forty3, percent_eighty3, percent_hundred3, percent_parity_zero3, percent_parity_one3, percent_parity_two3, percent_parity_three_plus3, percent_nonsmoker3, percent_smoker3, percent_nonalc3, percent_alc3, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
percent_home_1 <- 100*(nrow(filter(clust_smoking, home_1 == 1)))/nrow(clust_smoking)
percent_home_2 <- 100*(nrow(filter(clust_smoking, home_2 == 1)))/nrow(clust_smoking)
percent_home_3 <- 100*(nrow(filter(clust_smoking, home_3 == 1)))/nrow(clust_smoking)
percent_home_4 <- 100*(nrow(filter(clust_smoking, home_4 == 1)))/nrow(clust_smoking)

percent_city_van <- 100*(nrow(filter(clust_smoking, city_van == 1)))/nrow(clust_smoking)
percent_city_tor <- 100*(nrow(filter(clust_smoking, city_tor == 1)))/nrow(clust_smoking)
percent_city_ham <- 100*(nrow(filter(clust_smoking, city_ham == 1)))/nrow(clust_smoking)
percent_city_king <- 100*(nrow(filter(clust_smoking, city_king == 1)))/nrow(clust_smoking)
percent_city_mon <- 100*(nrow(filter(clust_smoking, city_mon == 1)))/nrow(clust_smoking)
percent_city_hal <- 100*(nrow(filter(clust_smoking, city_hal == 1)))/nrow(clust_smoking)

smoking_cluster_demog <- c(percent_male4, percent_female4, percent_age_nineteen4, percent_age_thirty4, percent_age_thirtyfive4, percent_white4, percent_nonwhite4, percent_hs4, percent_college4, percent_undergrad4, percent_grad4, percent_married4, percent_unmarried4, percent_under_forty4, percent_forty4, percent_eighty4, percent_hundred4, percent_parity_zero4, percent_parity_one4, percent_parity_two4, percent_parity_three_plus4, percent_nonsmoker4, percent_smoker4, percent_nonalc4, percent_alc4, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
percent_home_1 <- 100*(nrow(filter(clust_high, home_1 == 1)))/nrow(clust_high)
percent_home_2 <- 100*(nrow(filter(clust_high, home_2 == 1)))/nrow(clust_high)
percent_home_3 <- 100*(nrow(filter(clust_high, home_3 == 1)))/nrow(clust_high)
percent_home_4 <- 100*(nrow(filter(clust_high, home_4 == 1)))/nrow(clust_high)

percent_city_van <- 100*(nrow(filter(clust_high, city_van == 1)))/nrow(clust_high)
percent_city_tor <- 100*(nrow(filter(clust_high, city_tor == 1)))/nrow(clust_high)
percent_city_ham <- 100*(nrow(filter(clust_high, city_ham == 1)))/nrow(clust_high)
percent_city_king <- 100*(nrow(filter(clust_high, city_king == 1)))/nrow(clust_high)
percent_city_mon <- 100*(nrow(filter(clust_high, city_mon == 1)))/nrow(clust_high)
percent_city_hal <- 100*(nrow(filter(clust_high, city_hal == 1)))/nrow(clust_high)

high_cluster_demog <- c(percent_male5, percent_female5, percent_age_nineteen5, percent_age_thirty5, percent_age_thirtyfive5, percent_white5, percent_nonwhite5, percent_hs5, percent_college5, percent_undergrad5, percent_grad5, percent_married5, percent_unmarried5, percent_under_forty5, percent_forty5, percent_eighty5, percent_hundred5, percent_parity_zero5, percent_parity_one5, percent_parity_two5, percent_parity_three_plus5, percent_nonsmoker5, percent_smoker5, percent_nonalc5, percent_alc5, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
percent_city_mon <- 100*(nrow(filter(final_chem, city_mon == 1)))/nrow(final_chem)
percent_city_hal <- 100*(nrow(filter(final_chem, city_hal == 1)))/nrow(final_chem)

total_demog <- c(percent_male, percent_female, percent_age_nineteen, percent_age_thirty, percent_age_thirtyfive, percent_white, percent_nonwhite, percent_hs, percent_college, percent_undergrad, percent_grad, percent_married, percent_unmarried, percent_under_forty, percent_forty, percent_eighty, percent_hundred, percent_parity_zero, percent_parity_one, percent_parity_two, percent_parity_three_plus, percent_nonsmoker, percent_smoker, percent_nonalc, percent_alc, percent_home_1, percent_home_2, percent_home_3, percent_home_4, percent_city_van, percent_city_tor, percent_city_ham, percent_city_king, percent_city_mon, percent_city_hal)
...
# writing the table:
write.table(cluster_demographics, file="/home/ayonkman/Desktop/Cleaned Data/K-means Clustering Demographics.csv", sep=",", row.names = FALSE)
...
# VIQ 
klm_unadj_all_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_chem)
summary(klm_unadj_all_viq)
klm_unadj_all_viq$coefficients

# PIQ 
klm_unadj_all_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_chem)
summary(klm_unadj_all_piq)

# FSIQ 
klm_unadj_all_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_chem)
...
# VIQ 
klm_adj_all_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
summary(klm_adj_all_viq)
klm_adj_all_viq$coefficients

# PIQ 
klm_adj_all_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
summary(klm_adj_all_piq)

# FSIQ 
klm_adj_all_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
...
# VIQ 
klm_unadj_boys_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_boys)
summary(klm_unadj_boys_viq)
klm_unadj_boys_viq$coefficients

# PIQ 
klm_unadj_boys_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_boys)
summary(klm_unadj_boys_piq)

# FSIQ 
klm_unadj_boys_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_boys)
...
# VIQ 
klm_adj_boys_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_boys)
summary(klm_adj_boys_viq)
klm_unadj_boys_viq$coefficients

# PIQ 
klm_adj_boys_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_boys)
summary(klm_adj_boys_piq)

# FSIQ 
klm_adj_boys_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_boys)
...
# VIQ 
klm_unadj_girls_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_girls)
summary(klm_unadj_girls_viq)
klm_unadj_girls_viq$coefficients

# PIQ 
klm_unadj_girls_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_girls)
summary(klm_unadj_girls_piq)

# FSIQ 
klm_unadj_girls_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster, data=final_girls)
...
# VIQ 
klm_adj_girls_viq <- lm(viq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_girls)
summary(klm_adj_girls_viq)
klm_unadj_girls_viq$coefficients

# PIQ 
klm_adj_girls_piq <- lm(piq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_girls)
summary(klm_adj_girls_piq)

# FSIQ 
klm_adj_girls_fsiq <- lm(fsiq ~ phthalate_cluster + high_cluster + opps_cluster + smoking_cluster + ref_cluster + age_thirty + age_thirtyfive + race_other2 + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + prenatal_alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_girls)
...
klm_int_adj_all_viq <- lm(viq ~ high_cluster + final_chem$opps_cluster + smoking_cluster + phthalate_cluster + ref_cluster + int_high + int_opp + int_smoking + int_phthalate + age_thirty + age_thirtyfive + maternal_race + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
summary(klm_int_adj_all_viq)

klm_int_adj_all_piq <- lm(piq ~ high_cluster + opps_cluster + smoking_cluster + phthalate_cluster + ref_cluster + int_high + int_opp + int_smoking + int_phthalate + age_thirty + age_thirtyfive + maternal_race + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
summary(klm_int_adj_all_piq)

klm_int_adj_all_fsiq <- lm(fsiq ~ high_cluster + opps_cluster + smoking_cluster + phthalate_cluster + ref_cluster + int_high + int_opp + int_smoking + int_phthalate + age_thirty + age_thirtyfive + maternal_race + edu_college + edu_undergrad + edu_grad + married + income_forty + income_eighty + income_hundred + parity_one + parity_two + parity_three_plus + alc + home_2 + home_3 + home_4 + city_van + city_tor + city_ham + city_king + city_hal, data=final_chem)
summary(klm_int_adj_all_fsiq)

```
```{r prepping for plotting - all}

Profiles <- c("Ref", "Phthalate", "High", "OPPs", "Smoke")
klm_adj_all_viq
viq_coef_all <- as.matrix(klm_adj_all_viq$coef[c(6,2,3,4,5)]) 
...
viq_confint_all_lower <- as.matrix(confint(klm_adj_all_viq)[c(6,2,3,4,5),1])# calculating the lower tail of the confidence interval (tails off dots)
viq_confint_all_upper <- as.matrix(confint(klm_adj_all_viq)[c(6,2,3,4,5),2]) # upper end

piq_coef_all <- as.matrix(klm_adj_all_piq$coef[c(6,2,3,4,5)])
piq_coef_all[is.na(piq_coef_all)] <- 0
piq_confint_all_lower <- as.matrix(confint(klm_adj_all_piq)[c(6,2,3,4,5),1])
piq_confint_all_upper <- as.matrix(confint(klm_adj_all_piq)[c(6,2,3,4,5),2])

fsiq_coef_all <- as.matrix(klm_adj_all_fsiq$coef[c(6,2,3,4,5)])
fsiq_coef_all[is.na(fsiq_coef_all)] <- 0
fsiq_confint_all_lower <- as.matrix(confint(klm_adj_all_fsiq)[c(6,2,3,4,5),1])
fsiq_confint_all_upper <- as.matrix(confint(klm_adj_all_fsiq)[c(6,2,3,4,5),2])
...
viq_coef_boys <- as.matrix(klm_adj_boys_viq$coef[c(6,2,3,4,5)])
viq_coef_boys[is.na(viq_coef_boys)] <- 0
viq_confint_boys_lower <- as.matrix(confint(klm_adj_boys_viq)[c(6,2,3,4,5),1])
viq_confint_boys_upper <- as.matrix(confint(klm_adj_boys_viq)[c(6,2,3,4,5),2])

piq_coef_boys <- as.matrix(klm_adj_boys_piq$coef[c(6,2,3,4,5)])
piq_coef_boys[is.na(piq_coef_boys)] <- 0
piq_confint_boys_lower <- as.matrix(confint(klm_adj_boys_piq)[c(6,2,3,4,5),1])
piq_confint_boys_upper <- as.matrix(confint(klm_adj_boys_piq)[c(6,2,3,4,5),2])


fsiq_coef_boys <- as.matrix(klm_adj_boys_fsiq$coef[c(6,2,3,4,5)])
fsiq_coef_boys[is.na(fsiq_coef_boys)] <- 0
fsiq_confint_boys_lower <- as.matrix(confint(klm_adj_boys_fsiq)[c(6,2,3,4,5),1])
fsiq_confint_boys_upper <- as.matrix(confint(klm_adj_boys_fsiq)[c(6,2,3,4,5),2])
...
viq_coef_girls <- as.matrix(klm_adj_girls_viq$coef[c(6,2,3,4,5)])
viq_coef_girls[is.na(viq_coef_girls)] <- 0
viq_confint_girls_lower <- as.matrix(confint(klm_adj_girls_viq)[c(6,2,3,4,5),1])
viq_confint_girls_upper <- as.matrix(confint(klm_adj_girls_viq)[c(6,2,3,4,5),2])

piq_coef_girls <- as.matrix(klm_adj_girls_piq$coef[c(6,2,3,4,5)])
piq_coef_girls[is.na(piq_coef_girls)] <- 0
piq_confint_girls_lower <- as.matrix(confint(klm_adj_girls_piq)[c(6,2,3,4,5),1])
piq_confint_girls_upper <- as.matrix(confint(klm_adj_girls_piq)[c(6,2,3,4,5),2])


fsiq_coef_girls <- as.matrix(klm_adj_girls_fsiq$coef[c(6,2,3,4,5)])
fsiq_coef_girls[is.na(fsiq_coef_girls)] <- 0
fsiq_confint_girls_lower <- as.matrix(confint(klm_adj_girls_fsiq)[c(6,2,3,4,5),1])
fsiq_confint_girls_upper <- as.matrix(confint(klm_adj_girls_fsiq)[c(6,2,3,4,5),2])
...
print(doc, target = "k.regression.plot.pptx")
```
